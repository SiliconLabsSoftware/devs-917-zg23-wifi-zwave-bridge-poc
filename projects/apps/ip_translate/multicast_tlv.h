 ...
 */
uint16_t gen_mcast_ack_value(const zwave_connection_t *zw_conn, const mcast_status_t mcast_status[], uint16_t num_nodes, uint8_t *buf, u16_t buf_size);
