 ...
 * 128 * 8 + 256 - 1 = 1279
 */
#define ZW_LR_MAX_NODE_ID_IN_NVM   100
#define ZW_LR_MIN_NODE_ID     45
#define ZW_CLASSIC_MAX_NODES  45
#define ZW_MAX_NODES          ZW_CLASSIC_MAX_NODES //ZW_LR_MAX_NODE_ID
...
#define ZW_ROUTE_LOST_FAILED      0x04  /*Node Asked won't help us*/
...
ZW_SendConst(
  ...
  BYTE bChNo,               /*IN channel number to send RF test signal on*/
...
**    Get the received multicast frame's destinations nodes mask list
**    Side effects:
