...
#define F_SOF 0x01  /* Start Of Frame */
#define F_ACK 0x06  /* Acknowledge successful frame reception */
#define F_NAK 0x15  /* Not Acknowledge successful frame reception - please retransmit... */
#define F_CAN 0x18  /* Frame received (from host) was dropped - waiting for ACK */
