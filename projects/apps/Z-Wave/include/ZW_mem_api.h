...
**
** BYTE               RET 1 on success 0 on failure
** MemoryGetByte(
** WORD  offset,    IN   Application area offset
   BYTE *byte);     IN pointer to byte where output should be copied
**--------------------------------------------------------------------------*/
#define ZW_MEM_GET_BYTE(offset, byte) MemoryGetByte(offset, byte)
...
**
** unt8_t             RET 1 on success 0 on failure
** MemoryGetBuffer(
** WORD  offset,      IN   Application area offset
...
**  Side effects:
**--------------------------------------------------------------------------*/
extern BYTE               /*RET 1 on success 0 on failure*/
MemoryGetByte(
  WORD  offset,         /*IN Application area offset            */
  BYTE *byte);          /*IN pointer to byte where output should be copied */
...
**--------------------------------------------------------------------------*/
extern uint8_t /*RET 1 on success or 0 on failure*/
MemoryGetBuffer(
  WORD  offset,           /*IN   Application area offset   */
  BYTE  *buffer,          /*IN   Buffer pointer            */
