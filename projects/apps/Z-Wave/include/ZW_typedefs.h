...
#define IIBYTE BYTE   /* Internal indexed data byte */
#define IBYTE  BYTE    /* Internal data byte */
#define IWORD  WORD    /* Internal data word */
#define IDWORD DWORD   /* Internal data double word*/

#define XBYTE  BYTE   /* External data byte */
#define XWORD  WORD   /* External data word */
#define XDWORD DWORD  /* External data double word */
#define BBYTE  BYTE   /* Internal bit addressable byte */
...
#define CODE           /* Used for defining callback function which always */
