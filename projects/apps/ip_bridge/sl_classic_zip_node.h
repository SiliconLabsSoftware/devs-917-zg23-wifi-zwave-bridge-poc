 ...
 *
 * \note Since this function is also used as a callback from sl_zw_send_zip_data(),
 ...
 */
int ClassicZIPUDP_input(struct uip_udp_conn *c, uint8_t *data, uint16_t len, BOOL secure);
...
void ClassicZIPNode_SendUnsolicited(zwave_connection_t *__c,
                                    ...
                                    BYTE cmdLength, uip_ip6addr_t *destIP, uint16_t port, BOOL bAck);
