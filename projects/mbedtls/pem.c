                            ...
                            size_t pwdlen, size_t *use_len)
{
    ...
    ((void) pwdlen);
#endif /* PEM_RFC1421 */
    printf("mbedtls_pem_read_buffer\n");
    ...
    *use_len = (size_t) (end - data);
    ...
    printf("mbedtls_pem_read_buffer, block 2\n");
    ...
    printf("mbedtls_pem_read_buffer block 3\n");
    ...
    printf("mbedtls_pem_read_buffer block 4\n");
